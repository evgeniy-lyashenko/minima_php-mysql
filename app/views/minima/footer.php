...
<script type="text/javascript" src="<?php echo ASSETS ?>minima/js/responsee.js"></script>
<script type="text/javascript" src="<?php echo ASSETS ?>minima/js/jquery.events.touch.js"></script>
<script type="text/javascript" src="<?php echo ASSETS ?>minima/owl-carousel/owl.carousel.js"></script>
<script type="text/javascript" src="<?php echo ASSETS ?>minima/js/template-scripts.js"></script>
</body>
