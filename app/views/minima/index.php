...
<main role="main">
        ...
        <?php foreach ($data['posts'] as $row) : ?>
          <div class="s-12 m-6 l-five">
            <a class="image-with-hover-overlay image-hover-zoom" href="<?= ROOT . 'single_post/' . $row->url_address ?>" title="Portfolio Image">
              ...
              <img class="full-img" src="<?php echo ROOT . $row->image ?>" alt="" />
            </a>
          </div>
        <?php endforeach; ?>
      <?php endif; ?>
  ...
  <br />
  <section>
    <a href="<?= $data['prev_page'] ?>"><input type="button" class="s-12 submit-form button background-primary text-white" style="width: 200px;" value="Previous"></a>
